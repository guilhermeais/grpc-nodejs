...
proto.greet.GreetResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    greetings: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
...
/**
 * optional string greetings = 1;
 * @return {string}
 */
proto.greet.GreetResponse.prototype.getGreetings = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.greet.GreetResponse.prototype.setGreetings = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
